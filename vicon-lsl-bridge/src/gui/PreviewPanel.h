...
public:
    ...
    bool isRunning() const { return worker_ != nullptr; }
    bool recordingIsLoading() const { return file_loader_ != nullptr; }
    void startSessionPreview();
    void stopSessionPreview();
...
private:
    ...
    void applyLoadedRecording(PreviewFileLoader* loader);
