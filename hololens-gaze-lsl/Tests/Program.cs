...
internal static partial class Program
{
    private static int Main()
    {
        var tests = new Action[]
        {
            ...
            GazeDrainLearnsHowLateAReadingArrives,
            GazeDrainIsSuspendedAndRecoversAfterTheSdkFailsToReportEmpty,
            GazeDrainReadingsDoNotForgiveSdkFailures,
            GazeRateEstimatorMeasuresDeliveredRate,
            GazeRateEstimatorSeparatesSlowTrackerFromLostReadings,
            GazeBacklogDropsStaleSamples,
            GazeBacklogKeepsDrainedBatch,
            GazeBacklogToleratesJitterButNotAnUnusableSpan,
            GazePublisherReportsWaitingForProviderSample,
